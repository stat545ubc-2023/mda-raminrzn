...
For this section, I have used the glimpse() function. This allows me to quickly see a concise summary of each dataset's structure, including column names, data types, and sample data, allowing initial data exploration and understanding.
...
I selected the "apt_buildings" dataset because I was curious about exploring the features of apartment buildings. This dataset contains a set of information related to these buildings, including details about amenities, accessibility, heating systems, and more. I believe that analyzing this dataset will provide interesting insights into the characteristics of apartment buildings and patterns based on their age.
...
Is there a correlation between the year an apartment building was built and the presence amenities? 
...
In this analysis, we will explore and analyze a dataset containing information about apartment buildings in Toronto. Our goal is to gain insights into various attributes of these buildings, including amenities, construction years, and more, using R, dplyr, and ggplot2 for data analysis and visualization.

1.  Plot the distribution of a numeric variable.

I chose to create a histogram to visualize the distribution of the "year_built" variable in the "apt_buildings" dataset because it makes sense to understand the historical distribution of when these apartment buildings were constructed. 
...
I created a new variable, showing each building's age. This would could be useful, for investigating building age with other variables available in the dataset. Such as comparing older and newer buildings in terms of amenities and safety features.
...
I have examined the relationship Between building age and the number of units. As the data set has an outlier of a building with more than 4000 units and with only three buildings older than 150 years old, I have filtered the results to buildings with less than 4000 units and younger than 150 years old.
...
I have created a Tibble with building features and amenities so that later I could create a score For each building features, and examine the relationship between that score and other variables.
